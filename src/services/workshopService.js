...
export const workshopService = {
  ...
  getWorkshopById: (id) => axiosInstance.get(`/workshops/search/by-id/${id}`),

  searchByTitle: (title) => axiosInstance.get(`/workshops/search/by-title?title=${title}`),

  addWorkshop: (workshopData) => axiosInstance.post('/workshops/add-workshop', workshopData),

  updateWorkshop: (id, data) => axiosInstance.put(`/workshops/update/${id}`, data),
