...
const AdminHome = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      headerName: 'Status',
      flex: 1,
      renderCell: (params) => getStatusChip(params.row.startDate, params.row.endDate)
    },
    {
      field: 'actions',
      headerName: 'Actions',
...
//     { name: 'Qacc', enrollments: 190 },
//     { name: 'QIC', enrollments: 220 },
//     { name: 'QC2', enrollments: 150 }, // Changed duplicate QC to QC2
//     { name: 'QT&AI', enrollments: 180 },
//   ];
...
//   const recentActivities = [
//     { action: 'New workshop created', workshop: 'Quantum Information Theory', date: '2023-07-1' },
//     { action: 'Participant enrolled', workshop: 'Introduction to Quantum Computing', date: '2023-04-14' },
//     { action: 'Workshop completed', workshop: 'Workshop on Quantum Computing', date: '2023-04-13' },
//   ];
